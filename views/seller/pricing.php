        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="primary-menu margin-bottom-medium">
                    ...
                    <a href='/web/seller/pricing' class="primary-menu__item primary-menu__item--active">
...
<main>
    <section class="profile-personal">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="start-status block-underline margin-bottom-medium">
                        <img src="../../web/public/img/standart-offer.png" alt="standart-offer" class="start-status__image">
                        <p class="start-status__desription margin-bottom-light">
                            Place your advertisement and receive offers from clients around the world
                        </p>
                        <div class="row horizontal-center margin-bottom-medium">
                            <div class="col-lg-4">
                                <button class="button button--selecte">Select</button>
                            </div>
                        </div>
                    </div>
                    <div class="start-status">
                        ...
                        <p class="start-status__desription margin-bottom-light">
                            Get more offers from clients by highlighting your advertisement among others and by posting it in the upper lines of the search.
                        </p>
...
<script src="../../web/public/js/selecte.js"></script>